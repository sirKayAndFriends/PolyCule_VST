...
#include "heavyFiles/Heavy_polycule.h"
...
public:
    ...
    //send data to the Heavy bit where it will be DSP'ed
    HeavyContextInterface* context;
    void sendFloatToPlugin(hv_uint32_t receiverHash, float pitch);

private:
    //==============================================================================

    void renderPlugin(juce::AudioBuffer<float>& buffer, int sampleCount, int bufferOffset);
